...
function Post({ id, username, userImg, img, caption }) {
  ...
  const [comment, setComment] = useState(""); // comment type in client
  const [comments, setComments] = useState([]); // comment in server rederring
